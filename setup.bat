...
powershell -Command "wget https://www.spigotmc.org/resources/griefprevention.1884/download?version=94543 -UseBasicParsing -OutFile %~dp0\libs\GriefPrevention.jar"
powershell -Command "wget https://www.spigotmc.org/resources/combattagplus.4775/download?version=86004 -UseBasicParsing -OutFile %~dp0\libs\CombatTagPlus.jar"
powershell -Command "wget https://www.spigotmc.org/resources/anticombatlog.4278/download?version=31685 -UseBasicParsing -OutFile %~dp0\libs\AntiCombatLog.jar"
powershell -Command "wget https://www.spigotmc.org/resources/free-pvpmanager.845/download?version=85799 -UseBasicParsing -OutFile %~dp0\libs\PvPManager.jar"
